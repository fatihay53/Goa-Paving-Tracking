...
export default function ProjectEstimateTemplate({selectedData,updateDt}) {
    ...
    const selectProjectCategory = () => {
        ...
        setShowedHtml(<SelectProjectCategory
            setSelections={(selections) => setProject({...project, category: selections.name,categoryId:selections.id})}/>);
    }
        ...
        <div role="main">
            <ul className="form-section page-section">
                ...
                <li
                    ...
                    data-type="control_textbox"
                >
                    <div style={{display: 'flex'}} className="form-input-wide jf-required" data-layout="half">
                        <TextField
                            fullWidth
                            disabled={true}
                            style={{backgroundColor: 'white'}}
                        ...
                        />
                        <Button onClick={selectProjectCategory} icon="pi pi-search"
