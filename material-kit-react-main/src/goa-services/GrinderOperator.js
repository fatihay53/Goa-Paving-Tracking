...
export default function GrinderOperator() {
    useEffect(() => {
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12 onStep" data-animation="fadeInUp" data-time="300">
                                        <h2>
                                            <span class="color">Grinder Operator (cold milling machine)  </span>
                                        </h2>
                                        ...
                                        <ul>
                                            ...
                                            <li style={{listStyle: "circle", marginLeft: "30px"}}>Perform daily
                                                inspections of the Equipment & tools
                                            </li>
                                            <li style={{listStyle: "circle", marginLeft: "30px"}}>Clean, Grease, &
                                                perform basic maintenance on Equipment
                                            </li>
                                            <li style={{listStyle: "circle", marginLeft: "30px"}}>Record daily
                                                production
                                            </li>
                                            <li style={{listStyle: "circle", marginLeft: "30px"}}>Mark and measure work
                                                area
                                            </li>
                                            ...
                                            <li style={{listStyle: "circle", marginLeft: "30px"}}>Prior experience
                                                operating equipment a must (milling experience an asset,
                                                but not mandatory)
                                            </li>
                                            <li style={{listStyle: "circle", marginLeft: "30px"}}>Ability to work to
                                                strict deadlines
                                            </li>
                                            <li style={{listStyle: "circle", marginLeft: "30px"}}>Ability to follow
                                                orders
                                            </li>
